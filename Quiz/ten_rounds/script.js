    document.addEventListener("DOMContentLoaded", function () {
        ...
        // === VRAAG LADEN ===
            ...
            vraagElement.textContent = `Vraag ${huidigeVraagIndex + 1}: ${vraagInhoud.dialog}`;
        ...
        function controleerAntwoord() {
            ...
            if (gekozenId === juisteCharacterId) {
                ...
                // Foute knop: rood
                geselecteerdeKnop.button.style.background = "linear-gradient(to bottom, #d14343, #b32b2b)";
                ...
                antwoordKnoppen.forEach(knop => {
                    if (knop.textContent === juisteCharacter.name) {
                        knop.style.background = "linear-gradient(to bottom, #2d8f2d, #1e691e)";
        ...
        function beëindigQuiz() {
            ...
            toonMelding(""); // Maak de melding leeg
        }
